...
class CrudController extends Controller
{
    ...
    public function Editar(EditarRequest $request,$id){
        ...
        // if(count($todos_id_e) != count($id_e)){
        //     for($a = 0; $a < count($id_e); $a++ ){
        //         for($e =0; $e < count($eliminar_id); $e++){
        //             //dump($todos_id_e[$e]-> id_enlace);
        //             if($id_e[$a] == $eliminar_id[$e]){
        //                 dump('son la misma', $id_e[$a]);
        //                 unset($eliminar_id[$id_e[$a]]);
        //             }
        //         }
            
        // //     //if($todos_id_e[$a]->id_enlace != $id_e[$a]){
        // //     //         $algo = $valores[$a] -> id_enlace;
        // //     //         DB::update('Eliminar_Dato ?', [$algo]);
        // //     //         return('hola');
        // //     //     }
